        ...
        <SafeAreaView style={{flex: 1}} className="bg-primary">
            ...
            {activeItem !== 2 && <View className="flex-row justify-between items-center mx-2 mb-2">
                ...
                <View className="flex-row items-center justify-center">
                    <Text
                        className={`rounded-full w-[12px] h-[12px] ${activeItem === 0 ? 'bg-red-500' : 'bg-gray-100'}`}></Text>
                    <Text
                        className={`rounded-full mx-2 w-[12px] h-[12px] ${activeItem === 1 ? 'bg-red-500' : 'bg-gray-100'}`}></Text>
                    <Text
                        className={`rounded-full w-[12px] h-[12px] ${activeItem === 2 ? 'bg-red-500' : 'bg-gray-100'}`}></Text>
                </View>
                <TouchableOpacity
                    onPress={handleNext}
                    className="bg-red-500 p-5 rounded-full items-center justify-center">
                    <Image
